  ...
  return (
    <section className="px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <h2 className="aula-section-title mx-auto max-w-3xl text-2xl sm:text-4xl lg:mx-0">{aula.entregasTitulo}</h2>
        <div className="mt-10 space-y-5">
          {aula.entregas.map((item, index) => (
            <div key={item.titulo} className="flex flex-col items-center gap-2 border-b border-gray-800 pb-5 text-center lg:grid lg:grid-cols-[auto_1fr] lg:items-start lg:gap-4 lg:text-left">
