...
export const WhyDifferentWorkshopSection: React.FC = () => {
  ...
  const differences = [
    ...
    },
    {
      ...
      description: 'R$ 897,00 garante comprometimento e entrega real. Não é funil isca gratuito — é treinamento prático.'
    }
  ];
      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xs sm:text-sm text-gray-300 font-light leading-relaxed max-w-3xl mx-auto drop-shadow-md animate-fade-in-up" style={{animationDelay: '0.3s'}}>
            Entrega real, prática real, resultados reais. Investimento de R$ 897,00 para garantir comprometimento e qualidade.
          </p>
        </div>
